...
vcli aims to integrate into existing command line workflows with supporting piping in data, while also providing the richness & flexibility of browser-based visualizations.
